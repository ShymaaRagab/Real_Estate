...
function Rent() {
  ...
  const fetchData = async () => {
    try {
      const url = `http://localhost:5000/properties/rent?page=${currentPage}&limit=${recordsPerPage}`;
        ...
        <div className="rent-row">
            {Data.map(object => 
              ...
              <div className="img">
                ...
                <button onClick={() => handleViewProperties(object._id)}>View Proprties</button>
              </div>
