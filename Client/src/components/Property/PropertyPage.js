...
const Property = ({ task, deleteTask, onToggle }) => {
    ...
    const fetchExcuse = () => {
        ...
        .then((res) => {
            ...
            console.log( res.data.owner.profileImage);
    ...
    const  openWhatsApp = (Data) => {
        if (Data.owner && Data.owner.telephone) {
            ...
            var message = "Hello, I'm interested in "+ Data.name +", give me more details."; // Replace with your desired message
        ...
        <div className="App">
            ...
            <section className="rh_section rh_wrap--padding rh_wrap--topPadding">
                <div className="rh_page rh_page--fullWidth">
                    <div className="rh_page__head rh_page__property" style={{justifyContent:"space-between"}}>
                    ...
                    <div className="property-detail-slider-wrapper clearfix">
                        <div className="inspiry_property_masonry_style images_7">
                            ...
                            >
                                <img src={imageUrl} alt={`Image ${index + 1}`} style={{ height: '100%' }}/>
                            </a>
                            ))}
                                                ...
                                                <div id="property-content-section-overview" className="property-content-section property-overview">
                                                    ...
                                                    <div className="rh_property__id">
                                                        ...
                                                        <div className="rh_property__print">
                                                            <span className="favorite-btn-wrap favorite-btn-45" data-tooltip="Added to favorites">
                                                                <button
                                                                    className="favorite"
                                                                    onClick={() => handleFavoriteClick(Data._id)}
                                                                    style={{
                                                                    color: selectedSales.includes(Data._id) ? "darkred" : "#1ea69a",
                                                                    }}
                                                                >
                                                                    <FavoriteIcon className="favorite-icon"style={{ fontSize : "3rem"}} />
                                                                </button>
                                                            </span>
                                                        </div>
                                                    </div>
